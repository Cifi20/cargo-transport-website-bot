...
interface RegionTariffCardProps {
  region: RegionTariff;
  index: number;
  onCalculateRoute: () => void;
}

const RegionTariffCard = ({ region, index, onCalculateRoute }: RegionTariffCardProps) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <Button 
          ...
          className="w-full bg-gradient-to-r from-primary to-accent hover:shadow-2xl hover:shadow-primary/30 group/btn"
        >
...
export default RegionTariffCard;