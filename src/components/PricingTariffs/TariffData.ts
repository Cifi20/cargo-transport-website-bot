export const transportTariffs = [
  {
    ...
    features: ["Городские перевозки", "Документы", "Посылки", "Выезд +1 час к стоимости"],
    popular: false
  },
  {
    type: "Газель до 1.5т",
    ...
    price: "1200-1400₽/час",
    minOrder: "мин. заказ 4 часа",
    features: ["Мебель", "Бытовая техника", "Переезды", "Выезд +1 час к стоимости"],
    popular: true
  },
  {
    type: "Грузовик до 3т",
    ...
    features: ["Стройматериалы", "Крупногабарит", "Паллеты", "Выезд +1 час к стоимости"],
    popular: false
  },
  {
    type: "Грузовик до 5т",
